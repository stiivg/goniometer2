...
let fingerJoint = Joint.init(name: .init(common: "Finger", medical: "Interphalangeal"),
                             motions: [
                                MotionStruct.init(name: .init(common: "Bend", medical: "Flexion"),
                                    ...
                                    position: "",
                                    description: "Bend finger joint in towards palm",
                                    rotation: "CCW",
                                    insideOutside: "Outside",
                                ...
                                MotionStruct.init(name: .init(common: "Straighten", medical: "Extension"),
                                    ...
                                    position: "",
                                    description: "Bend finger joint away from palm",
                                    rotation: "CW",
                                    insideOutside: "Outside",
...
let thumb = Joint.init(name: .init(common: "Thumb", medical: "Thumb Carpometacarpal"),
                             motions: [
                                MotionStruct.init(name: .init(common: "In", medical: "Flexion"),
                                                       ...
                                                       normalAAOS: "",
                                                       position: "",
                                                       description: "Bring thumb sideways to palm",
                                                       rotation: "CW",
                                                       insideOutside: "Outside",
                                ...
                                MotionStruct.init(name: .init(common: "Out", medical: "Extension"),
                                                       ...
                                                       normalAAOS: "",
                                                       position: "",
                                                       description: "Move thumb sideways away from palm",
                                                       rotation: "CW",
                                                       insideOutside: "Outside",
                                ...
                                MotionStruct.init(name: .init(common: "Down", medical: "Abduction"),
                                                       ...
                                                       normalAAOS: "",
                                                       position: "",
                                                       description: "With hand palm down lower thumb below palm",
                                                       rotation: "CCW",
                                                       insideOutside: "Inside",
                                ...
                                MotionStruct.init(name: .init(common: "Up", medical: "Adduction"),
                                                       ...
                                                       normalAAOS: "",
                                                       position: "",
                                                       description: "With hand palm down raise thumb level with palm",
                                                       rotation: "CCW",
                                                       insideOutside: "Inside",
...
let hipJoint = Joint.init(name: .init(common: "Hip", medical: ""),
                           motions: [
                            MotionStruct.init(name: .init(common: "Thigh Forward", medical: "Flexion"),
                                                   ...
                                                   normalAAOS: "121,6.4",
                                                   position: "",
                                                   description: "Raise thigh in front of body",
                                                   rotation: "CCW",
                                                   insideOutside: "Outside",
                            ...
                            MotionStruct.init(name: .init(common: "Thigh Back", medical: "Extension"),
                                                   ...
                                                   normalAAOS: "12,5.4",
                                                   position: "",
                                                   description: "Push thigh back behind body",
                                                   rotation: "CW",
                                                   insideOutside: "Outside",
                            ...
                            MotionStruct.init(name: .init(common: "Thigh Out", medical: "Abduction"),
                                                   ...
                                                   normalAAOS: "41,6.0",
                                                   position: "",
                                                   description: "Move thigh out to side of body",
                                                   rotation: "CW",
                            ...
                            MotionStruct.init(name: .init(common: "Thigh In", medical: "Adduction"),
                                                   ...
                                                   normalAAOS: "27,3.6",
                                                   position: "",
                                                   description: "Move thigh in towards other leg",
                                                   rotation: "CW",
                                                   insideOutside: "Inside-90",
                                                   defaultDotPoints: [CGPoint(x: 100, y: 300), CGPoint(x: 100, y: 200), CGPoint(x: 150, y: 200)],
                                                   labelOffsets: ["Up", "Up", "Up"]),
                            MotionStruct.init(name: .init(common: "Leg Out", medical: "Medial (Internal) Rotation"),
                                                   ...
                                                   normalAAOS: "44,4.3",
                                                   position: "",
                                                   description: "Sitting with knee at 90 degrees rotate lower leg out to side",
                                                   rotation: "CW",
                                                   insideOutside: "Inside",
                            ...
                            MotionStruct.init(name: .init(common: "Leg In", medical: "Lateral (External) Rotation"),
                                                   ...
                                                   normalAAOS: "44,4.8",
                                                   position: "",
                                                   description: "Sitting with knee at 90 degrees rotate lower leg in",
                                                   rotation: "CCW",
                                                   insideOutside: "Inside",
...
let kneeJoint = Joint.init(name: .init(common: "Knee", medical: ""),
                           motions: [
                            ...
                            MotionStruct.init(name: .init(common: "Straighten", medical: "Extension"),
                                                   ...
                                                   position: "",
                                                   description: "Extend knee to straighten leg",
                                                   rotation: "CCW",
                                                   insideOutside: "Outside",
...
let heelJoint = Joint.init(name: .init(common: "Heel", medical: "Calcaneal (subtalar - hindfoot)"),
                           motions: [
                            MotionStruct.init(name: .init(common: "Roll Out", medical: "Inversion"),
                                              ...
                                              normalAAOS: "37,4.5",
                                              position: "",
                                              description: "Roll heel at ankle to the outside",
                                              rotation: "CW",
                                              insideOutside: "Outside",
                                              defaultDotPoints: [CGPoint(x: 100, y: 300), CGPoint(x: 100, y: 200), CGPoint(x: 150, y: 200)],
                                              labelOffsets: ["Up", "Up", "Up"]),
                            MotionStruct.init(name: .init(common: "Roll In", medical: "Eversion"),
                                              ...
                                              normalAAOS: "21,5.0",
                                              position: "",
                                              description: "Roll heel at ankle to the inside",
                                              rotation: "CW",
                                              insideOutside: "Outside",
                                              defaultDotPoints: [CGPoint(x: 100, y: 300), CGPoint(x: 100, y: 200), CGPoint(x: 150, y: 200)],
                                              labelOffsets: ["Up", "Up", "Up"]),])
...
let footJoint = Joint.init(name: .init(common: "Foot", medical: "Midtarsal (transverse tarsal) "),
                           motions: [
                            MotionStruct.init(name: .init(common: "Rotate Out", medical: "Inversion"),
                                              ...
                                              normalAAOS: "",
                                              position: "",
                                              description: "With ankle at 90 degrees rotate foot to raise side with little toe",
                                              rotation: "CW",
                                              insideOutside: "Outside-90",
                            ...
                            MotionStruct.init(name: .init(common: "Rotate In", medical: "Eversion"),
                                              ...
                                              normalAAOS: "",
                                              position: "",
                                              description: "With ankle at 90 degrees rotate foot to raise side with big toe",
                                              rotation: "CCW",
                                              insideOutside: "Outside-90",
...
let toeJoint = Joint.init(name: .init(common: "Toe", medical: "Metatarsophalangeal"),
                           motions: [
                            ...
                            MotionStruct.init(name: .init(common: "Out", medical: "Abduction"),
                                              ...
                                              normalAAOS: "",
                                              position: "",
                                              description: "Move toe sideways to outside",
                                              rotation: "CCW",
                                              insideOutside: "Outside",
                            ...
                            MotionStruct.init(name: .init(common: "In", medical: "Adduction"),
                                              ...
                                              normalAAOS: "",
                                              position: "",
                                              description: "Move toe sideways to inside",
                                              rotation: "CW",
                                              insideOutside: "Outside",
...
let neckJoint = Joint.init(name: .init(common: "Neck", medical: "Cervical Spine"),
                           motions: [
                            MotionStruct.init(name: .init(common: "Head Forward", medical: "Flexion"),
                                              ...
                                              normalAAOS: "70.5,7.5",
                                              position: "",
                                              description: "With back upright tilt head forward bringing chin to chest",
                                              rotation: "CW",
                                              insideOutside: "Inside-90",
                            ...
                            MotionStruct.init(name: .init(common: "Head Back", medical: "Eversion"),
                                              ...
                                              normalAAOS: "70.5,7.5",
                                              position: "",
                                              description: "With back upright tilt head back",
                                              rotation: "CW",
                                              insideOutside: "Inside",
                            ...
                            MotionStruct.init(name: .init(common: "Side Bending", medical: ""),
                                              ...
                                              normalAAOS: "46.5,6.5",
                                              position: "",
                                              description: "With back upright and shoulders level tilt head sideways with ear towards shoulder",
                                              rotation: "CW",
                                              insideOutside: "Outside",
                            ...
                            MotionStruct.init(name: .init(common: "Rotation", medical: ""),
                                              ...
                                              normalAAOS: "81,6.5",
                                              position: "",
                                              description: "With back upright and shoulders in line with hips rotate head to side",
                                              rotation: "CW",
                                              insideOutside: "Outside-90",
...
let backJoint = Joint.init(name: .init(common: "Back", medical: "Thoraco-Lumber Spine"),
                           motions: [
                            MotionStruct.init(name: .init(common: "Sidebending", medical: ""),
                                              ...
                                              normalAAOS: "27.1,6.5",
                                              position: "",
                                              description: "With hips level bend sideways from waist",
                                              rotation: "CW",
                                              insideOutside: "Outside",
                            ...
                            MotionStruct.init(name: .init(common: "Rotation", medical: ""),
                                              ...
                                              normalAAOS: "",
                                              position: "",
                                              description: "Rotate shoulders relative to hips",
                                              rotation: "CW",
                                              insideOutside: "Inside",
