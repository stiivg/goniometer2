...
class InfoViewController: UIViewController {
    ...
    let appVersionText = "App Version: " + Bundle.main.releaseVersionNumber! + " Build: " + Bundle.main.buildVersionNumber!
...
//        Bundle.main.buildVersionNumber
    ...
    fileprivate func sendEmail() {
        ...
        let coded = "mailto:steve@hanako.com?subject=\(subject)&body=\(body)".addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)
